...
class WebsocketProcessor {
  constructor() {
    ...
    this.ws = new WebSocket('/audiooutput');
  ...
  update() {
    document.querySelector('#value-received').innerHTML = this.received;
    document.querySelector('#value-buffer').innerHTML = this.leftBuffer.length;
  }
}
